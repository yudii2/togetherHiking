...
public class BoardDao {
	...
	public List<Board> selectBoardList(Connection conn, String field, String query) {
		List<Board> boardList = new ArrayList<Board>();
		PreparedStatement pstm = null;
		ResultSet rset = null;
		String sql = "select * from board where is_del = 0 and ";
	...
	public Board selectBoardByBdIdx(Connection conn, String bdIdx) {
		...
		ResultSet rset = null;
		Board board = null;
		String sql = "select bd_idx, title, user_id, subject, content, reg_date, is_del "
