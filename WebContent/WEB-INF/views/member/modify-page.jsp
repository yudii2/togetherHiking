      ...
      <form action="/member/modify" class="modify_form">
        <div class="name">
          <span class="tit_form">이름</span>
          	<input type="text" name="name" value="${authentication.userName}김유진" disabled>     
        </div>
        <div class="user_id">
          <span class="tit_form">아이디</span>
          	<input type="text" name="user_id" value="${authentication.userId}아이디" disabled>
        </div>
        <div class="nickname">
        ...
        <div class="self-intro">
          ...
          <textarea rows="5" minlength="15" maxlength="50" >${authentication.info}</textarea>
        </div>
        <div class="password">
          <span class="tit_form">비밀번호</span>
          <label for="password" class="tit_pw_label">현재 비밀번호</label>
          <em id="alert_pw" class="alert_auth">현재 비밀번호와 일치하지 않습니다</em>
          <input type="password" name="password" id="password" required>
          
          <label for="new_pw" class="tit_pw_label tit_new_pw">새 비밀번호</label>
          <em id="alert_new_pw" class="alert_auth">영문,숫자,특수문자 포함 8~15자를 입력하세요</em>
          <input type="password" name="new_pw" id="new_pw" required>
          
          <label for="new_pw_confirm" class="tit_pw_label tit_new_pw">새 비밀번호 확인</label>
          <em id="alert_check_pw" class="alert_auth">비밀번호가 일치하지 않습니다</em>          
          <input type="password" name="new_pw_confirm" id="new_pw_confirm" required>
        </div>
        <div class="email">
